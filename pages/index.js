...
const IndexPage = ({ posts, profile }) => (
  <Page style={{ minHeight: 'auto' }}>
    <Page.Header>
      <div style={{ backgroundColor: "#1a2634", width: "100%", height: "20vh", marginTop: "100px", display: "flex", alignItems: "center", justifyContent: "space-evenly", flexDirection: "column" }}>
